        ...
        <div class="card p-4">
            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <img src="./Pictures/adi 3.jpg" class="img-fluid rounded-circle mb-2" alt="Adi Redzic" style="width: 150px; height: 150px; object-fit: cover;">
                    <p>Adi Redzic</p>
                </div>
                <div class="col-md-6 text-center">
                    <img src="./Pictures/adi 3.jpg" class="img-fluid rounded-circle mb-2" alt="Emir Hamulic" style="width: 150px; height: 150px; object-fit: cover;">
                    <p>Emir Hamulic</p>
                </div>
            </div>
