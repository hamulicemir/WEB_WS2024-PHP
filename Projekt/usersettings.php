...
<head>
  ...
  <body>
              ...
              <nav class="nav flex-column nav-pills nav-gap-y-1">
                <a href="#account" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded active">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    class="feather feather-settings pe-1">
                ...
                <a href="#notification" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-bell pe-1">
          ...
          <div class="card">
            <div class="card-header border-bottom mb-3 d-flex d-md-none">
              <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                ...
                <li class="nav-item">
                  <a href="#account" aria-label="Account Settings" data-bs-toggle="tab" class="nav-link has-icon"><svg
                ...
                <?php if ($_SESSION['UserInformation']['Role_ID'] == 1): ?>
                  <li class="nav-item">
                    <a href="#usermanagement" aria-label="User Management Settings" data-bs-toggle="tab"
                      class="nav-link has-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <?php endif; ?>
                <li class="nav-item">
                  <a href="#notification" aria-label="User Notification Settings" data-bs-toggle="tab"
                    class="nav-link has-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <form action="usersettings.php" method="POST">
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" id="username" required class="form-control form-control-lg" placeholder="Username"
                      name="formUsername" autocomplete="off"
                  ...
                  <button class="btn btn-primary" onclick="window.location.href='./changepassword.php'"
                  ...
                  <button class="btn btn-danger" id="DeleteAccountTrigger" type="button" data-bs-toggle="modal"
                  data-bs-target="#DeleteModal">Delete Account?</button>

                  <div class="modal fade" id="DeleteModal" tabindex="-1" aria-label="Delete Account">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                          <a href="delete_current_user.php" id="SaveDeleteAccountButton" class="btn btn-danger">Delete</a>                        
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <?php if ($_SESSION['UserInformation']['Role_ID'] == 1): ?>
                <div class="tab-pane" id="usermanagement">
                  ...
                  <form>
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='./userlist.php'" type="button">View
                      Users</button>
                    <hr>
                    <div class="form-group">
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='./reservationlist_all.php'"
                      type="button">View Reservations</button>
              ...
              <div class="tab-pane" id="notification">
                ...
                <div class="form-group">
                  ...
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label mb-3" for="customCheck1">Email Reservation</label>
                    <!-- Benachrichtigung bei Reservierung, Werbung oder sonstiges... -->
                  </div>
                  <div class="custom-control custom-checkbox">
    ...
    <!--SEHR WICHTIG SONST SCHALTET NICHT -->
  </body>
