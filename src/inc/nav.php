...
//Holen die Dateibezeichnung unserer momentanen Seite
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item"><a href="./news.php"
              class="nav-link <?php echo $current_page == 'news.php' ? 'active' : ''; ?>">News</a></li>
          <li class="nav-item"><a href="./pictures.php"
              class="nav-link <?php echo $current_page == 'pictures.php' ? 'active' : ''; ?>">Pictures</a></li>
          <li class="nav-item"><a href="./FAQ.php"
              class="nav-link <?php echo $current_page == 'FAQ.php' ? 'active' : ''; ?>">FAQ</a></li>
          <li class="nav-item"><a href="./impressum.php"
              class="nav-link <?php echo $current_page == 'impressum.php' ? 'active' : ''; ?>">Imprint</a></li>
        </ul>
        <?php if ((isset(($_SESSION["loggedin"]))) && ($_SESSION["loggedin"])): ?>
          <div class="d-flex align-items-center">
            <a href="./reservation.php" class="btn btn-primary me-3">New Reservation</a>
            <div class="dropdown">
              <a href="#" id="dropdownUser1" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                aria-expanded="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                  class="bi bi-person-circle" viewBox="0 0 16 16" alt="User Settings" aria-label="User Settings">
